...
class CimatMRDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #    features.append(z)
        # Temporarily we are going to use only one channel (SAR image - origin), so we don't need to create the multichannel DNN
        # x = torch.stack(
        #     [
